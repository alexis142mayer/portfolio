...
export default function Contact() {
    ...
    return <>
        ...
        <div className="text-white">
            ...
            <div className="w-full flex flex-col items-end font-semibold text-right mt-8 px-4">
                ...
                <a href="ResumeAlexisMayer.pdf" target="_blank" rel="noopener noreferrer" className="w-fit text-3xl bg-primary dark:bg-neutral-400/20 text-neutral-600 dark:text-neutral-300 border border-neutral-400/20 p-2 rounded-4xl flex justify-center items-center text-left">
                    {t("downloadResume")}
