    ...
    return <div className="h-9/10 sm:h-3/4 w-full max-w-[1525px] flex justify-center items-center text-white">
        ...
        <div>
            ...
            <div className="w-fit flex flex-col font-semibold text-right">
                ...
                <a href="ResumeAlexisMayer.pdf" target="_blank" rel="noopener noreferrer" className="text-3xl bg-neutral-300/20 dark:bg-neutral-400/20 text-neutral-600 backdrop-invert dark:text-neutral-300 backdrop-blur-[1px] border border-neutral-400/20 p-3 rounded-4xl flex justify-center items-center text-left">
                    {t("downloadResume")}
